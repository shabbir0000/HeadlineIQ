...
const ShowProductbystatus = ({ navigation, route }) => {
...
export default ShowProductbystatus;
          ...
          try {
            updateDoc(doc(db, 'Products', pid), {
              ...
              .then(() => {
                console.log('done');
                setloading1(false);
                Alert.alert('Congratulation', `Status Has Been Updated`, [
          ...
          <View style={tw`mb-5 flex-row  items-center justify-center`}>
            ...
            >
              <View style={tw`mb-3 w-75 `}>
                ...
                <Image
                  style={[{ width: width * 0.85 }, tw`h-30 mt-5 rounded-xl`]}
