...
const Viewadminorder = ({ navigation, route }) => {
  ...
  return (
    <View style={[tw`flex-1`, { backgroundColor: '#ffffff' }]}>
      ...
      <ScrollView>
        ...
        {GetData[0]?.selecteduser?.orderstatus === 'dispatch' && (
          <View
            style={[
              { width: width * 0.92 },
              tw` mt-6 mb-5 h-50 self-center justify-evenly border border-gray-200 rounded-xl bg-white shadow-xl `,
            ...
            <View style={tw`flex-col justify-between`}>
              <View style={tw`flex-row justify-between`}>
                ...
                >
                  ...
                  <View>
                    <Text style={tw`ml-2 font-light text-base`}>
                      {GetData[0]?.selecteduser?.ridername}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View style={tw`flex-row justify-between`}>
                ...
                >
                  ...
                  <View>
                    <Text style={tw`ml-2 font-light text-base`}>
                      {GetData[0]?.selecteduser?.ridernum}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              {/* <View style={tw`flex-row justify-between`}>
                ...
                >
                  ...
                  <View>
                    <Text
                      numberOfLines={2}
                      style={tw`ml-2 font-light text-base`}
                    >
                      {GetData1[0]?.selecteduser?.address}
                    </Text>
                  </View>
        ...
        {GetData[0]?.selecteduser?.orderstatus === 'dispatch' && (
          <>
            <Dropdown
              style={[
                { width: width * 0.9 },
                tw`h-12 mt-3  shadow-lg
                self-center bg-white  rounded-md`,
              ]}
            ...
            {loading1 ? (
              ...
              <>
                <View style={tw`justify-between mb-5 self-center w-80 mt-5`}>
                  <Buttonnormal
                    onPress={() => {
                      Dispatch();
                    }}
        ...
        {GetData[0]?.selecteduser?.orderstatus === 'pending' && (
          <Dropdown
            style={[
              { width: width * 0.9 },
              tw`h-12 mt-3  shadow-lg
        ...
        {loading1 ? (
          ...
          <>
            {GetData[0]?.selecteduser?.orderstatus === 'pending' && (
              <>
                <>
                  {GetData[0]?.selecteduser.ridercall === 'online' ||
                  GetData[0]?.selecteduser.ridercall === 'conform' ? (
                    <></>
                  ) : (
                    <>
                      {loading1 ? (
                        ...
                        <>
                          {GetData[0]?.selecteduser.orderstatus == 'dispatch' ||
                          GetData[0]?.selecteduser.orderstatus == 'completed' ||
                          GetData[0]?.selecteduser.orderstatus == 'reject' ? (
                            <></>
                          ) : (
                            <>
                              <View
                                style={tw`justify-between self-center w-80 mt-5`}
                              >
                                <Buttonnormal
                                  // onPress={handleLogin}
                                  // onPress={() => Uploadata()}
