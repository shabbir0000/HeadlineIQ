...
const EvenOddColumns = ({ data, navigation }) => {
  ...
  const updateCat = async () => {
    if (!comapny || !catid || !label2) {
      ...
      try {
        ...
        await updateDoc(doc(db, 'Charges', catid), {
          company: comapny.trim().toLowerCase(),
          charges: fuel,
          type_l: label2,
          type_v: value2,
  ...
  const deleteCat = async docId => {
    try {
      ...
      await deleteDoc(doc(db, 'Charges', docId));
  ...
  const renderItem = ({ item }) => (
    <>
      <ScrollView showsHorizontalScrollIndicator={false}>
        <View style={tw`h-55 flex-row justify-around mt-5`}>
          <View
            style={[
              tw`h-50 w-40 items-center shadow-xl bg-white justify-${
                userflag ? 'around' : 'around'
              } rounded-2xl border `,
          ...
          >
            {userflag ? (
              ...
              <View style={tw`flex-row w-35 mt-2 justify-between`}>
                <TouchableOpacity
                  onPress={() => {
                    toggleModal(), setmname('UPDATE CHARGES');
                    ...
                    setfuel(item.even.selecteduser.fuel_charges);
            ...
            <Text
              ...
              style={[
                ...
                tw`text-${darkMode ? 'white' : 'black'} w-35 font-bold  `,
              ]}
            >
            ...
            >
              {item.even.selecteduser.fuel_charges}{" "}{item.even.selecteduser.type_l}
            </Text>
          </View>
          ...
          {item.odd && (
            <View
              style={[
                tw`h-50 w-40 items-center bg-white shadow-xl justify-${
                  userflag ? 'around' : 'around'
                } border  rounded-2xl`,
                { borderColor: darkMode ? '#ffffff' : 'lightgray' },
              ]}
            >
                ...
                <View style={tw`flex-row w-35 mt-2 justify-between`}>
                  <TouchableOpacity
                    onPress={() => {
                      ...
                      setfuel(item.odd.selecteduser.fuel_charges);
              ...
              >
                 {item.odd.selecteduser.fuel_charges}{" "}{item.odd.selecteduser.type_l}
              </Text>
            </View>
          )}
        </View>
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {userflag ? (
        ...
        <FAB
          onPress={() => {
            toggleModal(), setfuel(''), setmname('ADD CHARGES');
          }}
          ...
          >
            ...
            <View style={tw` flex-col  h-60 justify-around`}>
              ...
              <TextInput
                ...
                placeholder="Enter Charges Title"
              />

              <Dropdown
                style={tw`h-10 w-60 mt-5 self-center border border-${
                  darkMode ? 'white' : 'black'
                } `}
              ...
              {loading ? (
                ...
                <View style={tw`mt-5`}>
                  <TouchableOpacity
                    onPress={() => {
                      mname === 'ADD CHARGES' ? addcat() : updateCat();
                    }}
                  >
                    <View
                      style={[
